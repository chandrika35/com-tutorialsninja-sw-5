...
import com.tutorialsninja.customerlisteners.CustomListeners;
...
public class LaptopsAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        checkoutPage.enterBillingDetailsFirstName("Sita");
        checkoutPage.enterBillingDetailsLastName("Ram");
        checkoutPage.enterBillingDetailsEmail("Sit_aram" + getRandomAlphaNumericString(4) + "@gmail.com");
        Thread.sleep(500);
        checkoutPage.enterBillingDetailsTelephone("078567456475");
        checkoutPage.enterBillingDetailsAddress("111,Missenden House");
        checkoutPage.enterBillingDetailsCity("Chesham");
        checkoutPage.enterBillingDetailsPostcode("WD23 5TN");
        checkoutPage.enterBillingDetailsCountry("United Kingdom");
        Thread.sleep(500);
        checkoutPage.enterBillingDetailsRegionOrState("Hereford");
