...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        registerPage.sendFirstName("Sita");
        //3.4 Enter Last Name
        registerPage.sendLastName("Ram");
        //3.5 Enter Email
        registerPage.sendEmail("Sitaram_123@gmail.com");
        //3.6 Enter Telephone
        registerPage.sendTelephone("07583756475");
        //3.7 Enter Password
        registerPage.sendPassword("sita_ram123");
        //3.8 Enter Password Confirm
        registerPage.sendConfirmPassword("sita_ram123");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        ...
        homePage.selectMyAccountOptions("Login");
        //4.3 enter email
        loginPage.sendEmail("Sitaram_123@gmail.com");
        //enter password
        loginPage.sendPassword("sita_ram123");
        //click login
